...
const Card = () => {
  return (
    <div className="border cursor-pointer h-44 w-44 rounded-xl p-4 duration-200 hover:bg-indigo-700 shadow-xl hover:shadow-indigo-700">
      <div className="h-12 w-12 border rounded-full overflow-hidden mb-4">
        <img
